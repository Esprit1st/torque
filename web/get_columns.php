...
$colqry = mysqli_query($con, "SELECT id,description,type,favorite FROM $db_keys_table WHERE user='".$_SESSION["torque_userid"]."' AND populated = 1 ORDER BY description") or die(mysqli_error($con));
