...
$keyqry = mysqli_query($con, "SELECT id,description,units,type,min,max,populated,favorite FROM ".$db_name.".".$db_keys_table." WHERE user='".$_SESSION["torque_userid"]."' ORDER BY description") or die(mysqli_error($con));
$i = 0;
